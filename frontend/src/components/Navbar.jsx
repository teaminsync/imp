...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <ul className='hidden sm:flex gap-5 text-sm text-[#023047]'>
        <NavLink
          to='/'
          className='flex flex-col items-center gap-1 transition-transform duration-300 ease-in-out transform hover:scale-110'>
          <p>HOME</p>
        </NavLink>
        <NavLink
          to='/about'
        ...
        >
          ...
          {token && isDropdownOpen && (
            <div
              ...
              onMouseLeave={handleMouseLeave}
            >
              <div className='flex flex-col gap-2 py-3 px-4 bg-[#F5F7FA] text-[#023047] rounded'>
                {showProfile ? (
                  <>
                    <div className='flex items-center gap-2 mb-4'>
                      <IoArrowBack
                        className="cursor-pointer text-[#023047] transition-transform duration-300 ease-in-out transform hover:scale-110"
                        size={20}
                        onClick={handleProfileToggle}
                      />
                      <p className="font-semibold text-[#023047]">Back</p>
                    </div>
                    <div className="text-lg text-[#023047] flex flex-col gap-2 pb-3">
                  ...
                  <>
                    <p
                      ...
                      className='cursor-pointer hover:text-[#023047] text-lg transition-transform duration-300 ease-in-out transform hover:scale-110'
                    >
                      My Profile
                    </p>
                    <p
      ...
      <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-[#023047] text-white aspect-square rounded-full text-[8px]'>
            {getCartCount()}
          </p>
        </Link>
